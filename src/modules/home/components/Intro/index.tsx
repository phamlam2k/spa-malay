  ...
  return (
    <div className={className}>
      <div
        ...
        style={{
          backgroundImage: "url('/images/spa_intro.webp'), url('/images/spa_intro_fallback.webp')",
      ...
      >
        <div className='container mx-auto px-6 flex flex-col justify-center items-center relative'>
          ...
          <h2 className='font-bold text-2xl text-white text-center mb-8'>Booking để có trải nghiệm tốt</h2>
          <a
